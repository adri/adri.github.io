...
summary: The "Russian doll" approach is useful for nested partials caching in template. The implementation can be improved with preventing the "dog-pile" effect under high load. 
