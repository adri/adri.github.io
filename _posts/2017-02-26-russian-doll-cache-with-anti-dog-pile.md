...
Then I learned about the **"Russian doll" approach** for caching nested template fragments which works well for nested data. A prerequisite of this approach is, that there are *last updated timestamps* .
