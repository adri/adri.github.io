...
The domain is highly connected. A recipe has ingredients which can be in an order and so on. This makes it a great use-case for GraphQL. The main concepts are:
