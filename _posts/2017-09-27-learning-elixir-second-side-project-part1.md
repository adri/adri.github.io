...
### Picape
Picape (pronounced pɪk) is a website that I made to manage and order recipes and ingredients via a supermarket API. Ingredients are added automatically to an order. Here a demo how this looks like:
