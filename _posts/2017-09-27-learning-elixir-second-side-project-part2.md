...
I made a GraphQL API and a web interface with next.js + [Apollo](https://www.apollodata.com) to [manage and order recipes and ingredients via a supermarket API](/post/learning-elixir-first-side-project).
