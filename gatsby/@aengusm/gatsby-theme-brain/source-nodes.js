...
const getMarkdownNotes = require("@aengusm/gatsby-theme-brain/src/get-markdown-notes");
const insertLinks = require("@aengusm/gatsby-theme-brain/src/insert-links");
const generateSlug = require("@aengusm/gatsby-theme-brain/src/generate-slug");
...
const textNoEscaping = require("@aengusm/gatsby-theme-brain/src/text-no-escaping");

const chokidar = require("chokidar");

const http = require("http");
const url = require("url");
const externalMapFetcher = require("@aengusm/gatsby-theme-brain/src/external-map-fetcher");
const generateBrainMap = require("@aengusm/gatsby-theme-brain/src/generate-brain-map");
...
function generateNodes(
  ...
  allReferences.forEach(({ source, references, externalReferences }) => {
    ...
    references.forEach(({ title, text, previewMarkdown }) => {
      let reference = text;
